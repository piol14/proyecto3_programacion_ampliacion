...
CREATE TABLE IF NOT EXISTS `almacen`.`detalle_venta` (
  ...
  `nombreProveedor` VARCHAR(255) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `almacen`.`detalle_venta_SEQ`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `almacen`.`detalle_venta_SEQ` (
  `next_val` BIGINT NULL DEFAULT NULL)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_unicode_ci;
...
-- -----------------------------------------------------
-- Table `almacen`.`pedidoVenta_SEQ`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `almacen`.`pedidoVenta_SEQ` (
  `next_val` BIGINT NULL DEFAULT NULL)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_unicode_ci;
